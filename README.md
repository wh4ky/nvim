> [!NOTE]
> # Whacky's nvim config
> This Neovim config is based on dam9000's [kickstart-modular.nvim](https://github.com/dam9000/kickstart-modular.nvim) and JSW's [nvim config](https://github.com/jsw08/nvim).  
> Here's the README of kickstart-modular.nvim:  
